...
class SchemaContext:
    def __init__(self):
        ...
        self.relationships_path = os.path.join(self.base_path, "database_analysis", "relationships.json")
